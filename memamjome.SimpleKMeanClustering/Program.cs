...
// a. Launch Visual Studio and create a new C# console application,
// then zap away all template-code in Program.cs, copy the contents of this file in, and hit <F5>.
// or
// b. Copy this file to any convenient directory, launch the special Visual Studio Tools
// command shell, cd to your directory, at the prompt type csc.exe ClusteringKMeansProgram.cs and 
